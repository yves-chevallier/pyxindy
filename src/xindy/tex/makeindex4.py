...
def _build_temp_style(attrs: Iterable[str], dest: Path) -> Path:
    ...
    lines.extend(
        [
            ...
            '(define-location-class "Alpha-page-numbers"  ("ALPHA"))',
            '(define-location-class-order ("roman-page-numbers" "arabic-page-numbers" "alpha-page-numbers" "Roman-page-numbers" "Alpha-page-numbers"))',
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        style_path = _build_temp_style(attrs, Path(tmpdir) / "makeindex4.xdy")

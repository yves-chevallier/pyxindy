...
|   ↳ état courant | Démarrage : implémenter un renderer texte minimal (structure → flux) basé sur les données `Index`. | Module `xindy.markup`. | Nouveaux tests unitaires `tests/markup/*` utilisant les fixtures synthétiques. |

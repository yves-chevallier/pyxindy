...
|   ↳ état courant | Renderer texte minimal en place (structure → flux, locrefs, crossrefs). | Module `xindy.markup`. | Tests unitaires `tests/markup/*` utilisant les fixtures synthétiques. |
